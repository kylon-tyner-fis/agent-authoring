...
export function AgentEditor({ id }: AgentEditorProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-xl shadow-sm border border-slate-200 m-4 overflow-hidden relative">
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-fuchsia-50 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            onClick={() => alert("Will open Sandbox slide-over")}
          >
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="pt-2">
              ...
              <p className="text-xs text-slate-500 mb-2">
                ...
                persona? What are its goals? (Global system instructions will be
                prepended to this automatically).
              </p>
              <textarea
                id="system_prompt"
                name="system_prompt"
