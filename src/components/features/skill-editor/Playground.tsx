...
export const Playground = ({
  ...
  const handleCopyTrace = async () => {
    ...
    messages.forEach((m) => {
      trace += `**${m.role === "user" ? "User" : "Assistant"}:**\n${m.content}\n\n`;
    });
