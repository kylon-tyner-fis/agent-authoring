  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-sm border-2 transition-all w-[250px] ${
        selected
          ? "border-fuchsia-500 shadow-md ring-4 ring-fuchsia-50"
          : "border-slate-200"
      }`}
    >
      {/* Input Handle (Top) */}
      ...
      {/* Node Header */}
      <div className="bg-fuchsia-50/50 border-b border-fuchsia-100 p-3 flex items-center gap-3 rounded-t-xl">
        <div className="w-8 h-8 rounded-lg bg-fuchsia-100 flex items-center justify-center shrink-0 text-fuchsia-600">
